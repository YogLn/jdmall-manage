    ...
    }, 
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import( /* webpackChunkName: "table" */ "../views/baseTable/BaseTable.vue")
            },
            {
                path: "/charts",
                name: "basecharts",
                ...
                component: () => import( /* webpackChunkName: "charts" */ "../views/charts/BaseCharts.vue")
            },
            {
                path: "/form",
                name: "baseform",
                ...
                component: () => import( /* webpackChunkName: "form" */ "../views/form/BaseForm.vue")
            },
            {
                path: "/permission",
                name: "permission",
