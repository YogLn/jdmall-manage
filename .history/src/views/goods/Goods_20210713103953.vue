    ...
    <el-card>
      <el-table :data="goodList"
        ...
        <el-table-column prop="auditState"
                         ...
                         width="150">
          <template #default="scope">
            <el-tag v-if="scope.row.auditState === 0" type="info">待审核</el-tag>
            <el-tag v-else-if="scope.row.auditState === 1" type="success">通过</el-tag>
            <el-tag v-else-if="scope.row.auditState === 1" type="danger">通过</el-tag>
          </template>
        </el-table-column>
