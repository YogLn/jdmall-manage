      ...
      <el-table :data="goodList" border style="width: 100%">
        ...
        <el-table-column fixed="right" label="操作" width="180">
          <template #default="scope">
            ...
            <el-button type="danger" size="small" @click="deleteGoodsAction(scope.row.id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
...
import { getGoodsList, addGoods,deleteGoods } from "../../services/goods";
export default {
  setup() {
